...
\documentclass{cbxposter-deep3m}
...
\authors {Christopher Batten}
\inst    {Batten Research Group, Cornell University}
\event   {DEEP3M Center Annual Review, July 11--12, 2019}
\task    {Architecture Theme, Task \#2758.004}
